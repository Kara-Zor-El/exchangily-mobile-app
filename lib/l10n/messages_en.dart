...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "lockedOutPerm" : MessageLookupByLibrary.simpleMessage("Too many failed attempts, please try to unlock using Pin or Password"),
    ...
    "pleaseSetupDeviceSecurity" : MessageLookupByLibrary.simpleMessage("Please setup the device security either using Pin/Password or Biometric in the phone app settings"),
    ...
    "specialWithdrawFailNote" : MessageLookupByLibrary.simpleMessage("In this case, withdraws on one chain may be temporarily unavailable, and you may withdraw a smaller amount, or withdraw to another chain."),
    ...
    "tsWalletNote" : MessageLookupByLibrary.simpleMessage("The coinpool (managed by consensus) holds deposited funds for withdrawal, and is controlled collectively by the miners of the kanban blockchain."),
    ...
    "walletDashboardInstruction2" : MessageLookupByLibrary.simpleMessage("Transfer funds from wallet to exchange to trade and use bindpay"),
